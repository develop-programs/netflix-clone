...
export default function Navbar() {
  ...
  const { Position, handleScroll, handleLeave } = useScroll();
    ...
    >
          ...
          {Data.map((item, index) => {
            return (
              <Link
                ...
                } text-sm font-medium hover:text-white duration-300`}
              >
                {item.name}
              </Link>
            );
      ...
      <div className="flex-1 flex gap-4 justify-end items-center">
        <div
          className={`${
            Toggle
              ? "w-80 border border-white"
              : "w-6 flex justify-center items-center"
          } flex items-center flex-nowrap overflow-hidden`}
        >
          <Button
            variant="ghost"
            size="icon"
          ...
          <input
            ...
            } py-2 px-2 outline-none bg-transparent`}
            placeholder="Search"
          />
        </div>
        <div>
        ...
        <div className="flex items-center">
          <Popover>
            ...
            <PopoverContent
              align="end"
              className="w-52 grid gap-4 mt-3 text-sm"
            >
              ...
              <Link href="" className="hover:underline flex gap-3">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <Button className="bg-transparent hover:bg-transparent text-white hover:underline">
                Sign out of Netflix
              </Button>
            </PopoverContent>
          </Popover>

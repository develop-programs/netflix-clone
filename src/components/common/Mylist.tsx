...
import { RemoveFromList } from "@/services/Redux/Reducers/MyList";

export default function Mylist() {
  const dispatch = useDispatch<AppDispatch>();
  const myList = useSelector((state: any) => state.MyList.data);
        ...
        <div key={index} className="flex">
          <div>
            <Image
              ...
              width={500}
              height={500}
              className="w-full h-44 rounded-md aspect-video object-cover"
              priority
            />
          </div>
